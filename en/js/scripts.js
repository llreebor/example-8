...
//         }
//         return `
//             <a href="" class="select__item ${cls}" data-type="item" data-id="${item.id}">${item.value}</a>
//         `
//     })
//     return `
...
if (document.querySelector('#home')) {
    ...
    const laptopScreen = window.matchMedia('(min-width: 1366px)')
    const wrapper = document.querySelector('.section__steps')

    if (laptopScreen.matches) {
        const panels = gsap.utils.toArray('.step__wrapper')
...
// Concepts page scripts
if (document.querySelector('#concepts')) {
    gsap.registerPlugin(ScrollTrigger)
    gsap.to('.title__img', {
        scrollTrigger: {
...
if (document.querySelector('.modal__btn')) {
    ...
    const modal = document.querySelector('.thanks__modal')
